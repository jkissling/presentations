require([
	...
	"dojo/domReady!"
], function (Map, MapView, FeatureLayer, PopupTemplate, SimpleMarkerSymbol, Color, Legend, LayerList) {
	...
	// Watching the zoom level of our View
	mapView.watch("zoom", function(zoom) {
		// If zoom level > 12 then hide our FeatureLayer
		if (zoom > 12) {
